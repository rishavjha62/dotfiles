...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /home/risjha/programming/my-notes<cr>")
--
...
vim.keymap.set("n", "<leader>os", function()
	require("telescope.builtin").find_files({ search_dirs = { my_path } })
end, { desc = "Find files in my notes vault" })

vim.keymap.set("n", "<leader>oz", function()
	require("telescope.builtin").live_grep({ search_dirs = { my_path } })
...
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /home/risjha/programming/my-notes/zettelkasten<cr>:bd<cr>")
